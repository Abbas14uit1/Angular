...
// definitions
import { IGame } from "../../../../../../typings/athlyte/baseball/game.d";
import { IPlay } from "../../../../../../typings/athlyte/baseball/play.d";
import { IPlayer, IPlayerDynamicData, IPlayerStaticData } from "../../../../../../typings/athlyte/baseball/player.d";
import { ITeam, ITeamDynamicData, ITeamStaticData } from "../../../../../../typings/athlyte/baseball/team.d";
 ...
 */
export abstract class BaseballStatcrewImportBase extends AthlyteImporter {
  /**
   ...
   */
  public abstract dependents: BaseballStatcrewImportBase[];
   ...
   * @param db Mongo DB
   */
  public abstract async generateId(db: mongo.Db, sportCode: "MBA" | "WSB"): Promise<string>;
   ...
   */
  public registerDependents(deps: BaseballStatcrewImportBase[]) {
