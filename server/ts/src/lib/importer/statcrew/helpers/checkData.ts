 ...
 */
export function checkInputData(input: IStatcrewFootballJSON) {
 ...
 */
export function checkInputHelper(input: any, example: any, context: string): boolean {
  ...
  for (const prop of inputProps) {
    if (exampleProps.indexOf(prop) === -1) {
      winstonLogger.log("info", "unexpected property " + context + "." + prop + " in input");
