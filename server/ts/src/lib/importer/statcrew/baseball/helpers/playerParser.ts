...
import * as AthlyteCommon from "../../../../../../../../typings/athlyte/baseball/common-stats.d";
import * as AthlytePlayer from "../../../../../../../../typings/athlyte/baseball/player.d";
...
export function parsePlayer(
  ...
  side: VH,
  gameDate: Date,
  actualDate: string, sportCode: "MBA" | "WSB"):
  AthlytePlayer.IPlayer {
      
  let stats: AthlyteCommon.ICommonStats ={};
  ...
  stats.hitting = {
      ...
      tb: computeTotalBases(player.hitting? player.hitting[0].$.h : 0,
    ...
    stats.pitching = {      
      ...
      tb: computeTotalBases(player.pitching? player.pitching[0].$.h || 0 : 0,
                  player.pitching? player.pitching[0].$.double || 0: 0, 
                  player.pitching? player.pitching[0].$.triple || 0: 0,
                  player.pitching? player.pitching[0].$.hr || 0: 0,)
    };
    ...
    const hitSituation: AthlyteCommon.IHittingSituation[] = [];
  ...
  const bats: string = player.$.bats;
  const throws: string = player.$.throws;
