...
import { KeyedCollection } from "../../../utility/KeyedCollection";
 ...
 */
export class Player extends BaseballStatcrewImportBase {
  ...
  public static playerRef = new KeyedCollection<Number>();
  ...
  public parse(
    ...
    opponentName: string,
    oppoConfName: string,
    oppoConfDivision: string,
    side: VH,
    gameDate: Date,
    actualDate: string, sportCode: "MBA" | "WSB" ): void {   
    this.parsedData = parsePlayer(player, teamCode, teamName, teamTidyName, confName, confDivision, opponentCode, opponentName, 
            oppoConfName, oppoConfDivision, side, gameDate,actualDate, sportCode);    
