 ...
 */
export class TeamGame extends BasketballStatcrewImportBase {
   ...
   */
  public async generateId(db: mongo.Db, sportCode: "MBB" | "WBB" ) {
  ...
  public parse(inputTeam: StatcrewTeam.ITeam,
    ...
    gameDate: Date, actualDate: string, sportCode: "MBB" | "WBB", inputVenue: StatcrewVenue.IVenue): void {
