...
import { IPlayer, IPlayerDynamicData, IPlayerStaticData } from "../../../../../../typings/athlyte/football/player.d";
import { ITeam, ITeamDynamicData, ITeamStaticData } from "../../../../../../typings/athlyte/football/team.d";
 ...
 */
export abstract class StatcrewImportBase extends AthlyteImporter {
  /**
   ...
   */
  public abstract dependents: StatcrewImportBase[];
   ...
   * @param db Mongo DB
   */
  public abstract async generateId(db: mongo.Db): Promise<string>;
   ...
   */
  public registerDependents(deps: StatcrewImportBase[]) {
