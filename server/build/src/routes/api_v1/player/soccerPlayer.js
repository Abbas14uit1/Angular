...
class SoccerPlayer {
    ...
    getStatsSeasonPipeline(sportCode, playerId) {
        const season_dict = {
            _id: playerId,
            tidyName: "$tidyName",
            name: "$name",
    ...
    getStatsCareerPipeline(sportCode, playerId) {
        const career_dict = {
            _id: playerId,
            tidyName: "$tidyName",
            name: "$name",
    ...
    getStatsGamePipeline(sportCode, playerId) {
        return [
    ...
    buildAggregateExp(sportCode, playerId, idGrp) {
        return [
            { $match: { sportCode: sportCode, _id: playerId }, },
            { $unwind: "$games" },
            {
...
//# sourceMappingURL=soccerPlayer.js.map