...
class BasketballPlayer {
    ...
    getStatsCareerPipelineBasketball(sportCode, playerId) {
        return [
    ...
    getStatsSeasonPipelineBasketball(sportCode, playerId) {
        return [
            { $match: { sportCode: sportCode, _id: playerId }, },
            { $unwind: "$games" },
            { "$match": { "games.pos.gp": 1 } },
    ...
    getStatsGamePipelineBasketball(sportCode, playerId) {
        return [
            { $match: { sportCode: sportCode, _id: playerId }, },
            { $unwind: "$games" },
            { "$match": { "games.pos.gp": 1 } },
...
exports.BasketballPlayer = BasketballPlayer;
//# sourceMappingURL=basketballPlayer.js.map