...
const gameRoutes = express_1.Router();
exports.gameRoutes = gameRoutes;
// /api_v1/game/:gameId
// Get the game summary data
gameRoutes.get("/:sportCode/:gameId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        const gameInfo = yield db.collection("games").aggregate(pipeline).toArray();
        res.status(200).json({
            data: gameInfo,
        });
    }
...
gameRoutes.get("/:sportCode/teams/:gameId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const gameTeams = yield db.collection("teamGames").aggregate(pipeline).toArray();
        res.status(200).json({
            data: gameTeams,
        });
    }
...
gameRoutes.get("/:sportCode/teamstats/:gameId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = getTeamStatPipeline(req.params.gameId, req.params.sportCode);
    try {
        const gameTeams = yield db.collection("teamGames").aggregate(pipeline).toArray();
        res.status(200).json({
            data: gameTeams,
...
gameRoutes.get("/:sportCode/starterroster/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = getStarterRoster(req.params.gameId, req.params.sportCode, req.params.teamId);
    try {
...
gameRoutes.get("/:sportCode/fullroster/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
...
gameRoutes.get("/:sportCode/rushing/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const rush = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: rush,
        });
    }
...
gameRoutes.get("/:sportCode/passing/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const pass = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: pass,
        });
    }
...
gameRoutes.get("/:sportCode/receiving/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const rcv = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: rcv,
        });
    }
...
gameRoutes.get("/:sportCode/receiving/targets/:gameId/:playerId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const targets = yield db.collection("plays").aggregate(pipeline).toArray();
        res.status(200).json({
            data: targets,
        });
    }
...
gameRoutes.get("/:sportCode/defense/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const def = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: def,
        });
    }
...
gameRoutes.get("/:sportCode/interceptions/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const interceptions = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: interceptions,
        });
    }
...
// /api_vi/game/interceptions/:gameId/:teamId
// Get the interceptions player data for a team for a game
gameRoutes.get("/:sportCode/fumbles/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const fumbles = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: fumbles,
        });
    }
...
gameRoutes.get("/:sportCode/hitting/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
...
gameRoutes.get("/:sportCode/pitching/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
...
gameRoutes.get("/:sportCode/fielding/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
...
gameRoutes.get("/:sportCode/baserunning/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
...
gameRoutes.get("/:sportCode/shooting/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        winstonLogger_1.winstonLogger.log("info", JSON.stringify(pipeline));
        const rush = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: rush,
        });
...
gameRoutes.get("/:sportCode/rebound/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
...
gameRoutes.get("/:sportCode/other/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
...
gameRoutes.get("/:sportCode/special/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
...
gameRoutes.get("/:sportCode/teamIds/:gameId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const ids = yield db.collection("games").aggregate(pipeline).toArray();
        res.status(200).json({
            data: ids,
        });
    }
...
gameRoutes.get("/:sportCode/plays/:gameId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        { $match: { "gameId": req.params.gameId, "sportCode": req.params.sportCode, "results.playersInvolved": { $ne: [] } } },
    ];
    try {
        const plays = yield db.collection("plays").aggregate(pipeline).toArray();
        res.status(200).json({
            data: plays,
        });
    }
...
gameRoutes.get("/:sportCode/player-name/:playerId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
...
gameRoutes.get("/:sportCode/plays/scoring/:gameId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = getTeamScoringPlayPipeline(req.params.gameId, req.params.sportCode);
    try {
        const plays = yield db.collection("plays").aggregate(pipeline).toArray();
        res.status(200).json({
            data: plays,
...
gameRoutes.get("/:sportCode/specialstats/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
...
function getTeamStatPipeline(gameId, sportCode) {
    switch (sportCode) {
        case "MFB":
...
function getTeamStatPipelineFootball(gameId, sportCode) {
    const pipeline = [
        {
            $match: {
                "gameId": gameId,
...
function getTeamStatPipelineBaseball(gameId, sportCode) {
    const pipeline = [
        {
            $match: {
                "gameId": gameId,
...
function getTeamStatPipelineBasketball(gameId, sportCode) {
    const pipeline = [
        {
            $match: {
                "gameId": gameId,
...
function getTeamScoringPlayPipeline(gameId, sportCode) {
    switch (sportCode) {
        case "MFB":
...
function getTeamScoringPlayPipelineFootball(gameId, sportCode) {
    const pipeline = [
...
function getTeamScoringPlayPipelineBaseball(gameId, sportCode) {
    const pipeline = [
...
function getTeamScoringPlayPipelineBasketball(gameId, sportCode) {
    const pipeline = [
        { $match: { gameId: gameId, "sportCode": sportCode, score: { $ne: null } } },
        {
            $project: {
...
function getStarterRoster(gameId, sportCode, teamId) {
    switch (sportCode) {
        case "MFB":
...
function getStarterPipelineFootball(gameId, sportCode, teamId) {
    return [
        {
            $match: {
                "games.gameId": gameId,
...
function getStarterPipelineBaseball(gameId, sportCode, teamId) {
    return [
        {
            $match: {
                "games.gameId": gameId,
...
function getStarterPipelineBasketball(gameId, sportCode, teamId) {
    return [
        {
            $match: {
                "games.gameId": gameId,
...
//VAF Code
//Soccer TeamStat
function getTeamStatPipelineSoccer(gameId, sportCode) {
    const pipeline = [
        {
            $match: {
                "gameId": gameId,
...
function getTeamScoringPlayPipelineSoccer(gameId, sportCode) {
    const pipeline = [
        { $match: { gameId: gameId, "sportCode": sportCode, score: { $ne: null } } },
        { $sort: { "score.homeScore": 1, "score.visitorScore": 1 } },
...
function getStarterPipelineSoccer(gameId, sportCode, teamId) {
    return [
        {
            $match: {
                "games.gameId": gameId,
...
gameRoutes.get("/:sportCode/goalie/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const goalie = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: goalie,
        });
    }
...
gameRoutes.get("/:sportCode/shots/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    try {
        const shots = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: shots,
        });
    }
...
gameRoutes.get("/:sportCode/penalties/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    // console.log({"sportCode":req.params.sportCode,"gameId":req.params.gameId,"teamId":req.params.teamId});
    try {
        const penalties = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: penalties,
        });
    }
...
gameRoutes.get("/:sportCode/misc/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    // console.log({"sportCode":req.params.sportCode,"gameId":req.params.gameId,"teamId":req.params.teamId});
    try {
        const misc = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: misc,
        });
    }
...
gameRoutes.get("/:sportCode/scoring/:gameId/:teamId", (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    const db = req.app.locals.db;
    const pipeline = [
        {
            $match: {
    ...
    // console.log({"sportCode":req.params.sportCode,"gameId":req.params.gameId,"teamId":req.params.teamId});
    try {
        const scoring = yield db.collection("players").aggregate(pipeline).toArray();
        res.status(200).json({
            data: scoring,
        });
    }
