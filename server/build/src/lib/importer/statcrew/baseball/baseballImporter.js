 ...
 */
class BaseballImporter extends AthlyteImporter_1.AthlyteImporter {
    constructor() {
        super();
...
exports.BaseballImporter = BaseballImporter;
/**
 ...
 */
function saveGameComponents(db, players, game, homeTeam, visitingTeam, plays, homeTeamGame, visitingTeamGame) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const visitorGameId = yield visitingTeamGame.save(db);
...
//# sourceMappingURL=baseballImporter.js.map