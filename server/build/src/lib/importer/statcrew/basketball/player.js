 ...
 */
class Player extends BasketballStatcrewImportBase_1.BasketballStatcrewImportBase {
    constructor() {
        super();
        this.dependents = [];
     ...
     */
    parse(player, teamCode, teamName, teamTidyName, teamConference, teamConferenceDivision, opponentCode, opponentName, opponentConference, opponentConferenceDivision, side, gameDate, actualDate, sportCode) {
        this.parsedData = playerParser_1.parsePlayer(player, teamCode, teamName, teamTidyName, teamConference, teamConferenceDivision, opponentCode, opponentName, opponentConference, opponentConferenceDivision, side, gameDate, actualDate, sportCode);
    }
    /**
