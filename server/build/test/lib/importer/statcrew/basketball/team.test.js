...
const team_1 = require("../../../../../src/lib/importer/statcrew/basketball/team");
const TeamParser = require("../../../../../src/lib/importer/statcrew/basketball/helpers/teamParser");
...
ava_1.test.before("read full input file", (t) => __awaiter(this, void 0, void 0, function* () {
    inputData = yield _data_helperBasketball_1.readJson();
