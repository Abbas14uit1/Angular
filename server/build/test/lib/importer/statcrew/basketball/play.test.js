...
const play_1 = require("../../../../../src/lib/importer/statcrew/basketball/play");
const _data_helperBasketball_1 = require("../_data.helperBasketball");
let simpleParsed;
let data;
...
ava_1.test.before("read data from file", (t) => __awaiter(this, void 0, void 0, function* () {
    data = yield _data_helperBasketball_1.readJson();
}));
ava_1.test("parsing entire file throws no errors", (t) => __awaiter(this, void 0, void 0, function* () {
    t.notThrows(() => play_1.parsePlays(data.plays[0], "MBB"));
}));
ava_1.test("parsing entire file produces list of plays", (t) => __awaiter(this, void 0, void 0, function* () {
    t.true(play_1.parsePlays(data.plays[0], "MBB").length > 0);
}));
ava_1.test("period: parses period number", (t) => {
    const period = simpleParsed.period;
    t.is(period, 1);
});
ava_1.test("Action: parses play in game to value", (t) => {
    const primaryPlay = simpleParsed.action;
    t.is(primaryPlay, "GOOD");
});
ava_1.test("type: parses type from plays", (t) => {
    const type = simpleParsed.type;
    t.is(type, "JUMPER");
});
ava_1.test("scoring: parses score", (t) => {
