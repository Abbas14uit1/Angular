 ...
 */
exports.defaultDataPath = path.join(_testConfiguration_1.fixtureDir, "json", "statcrew", "01UA-USC.json");
exports.defaultFailedFilePath = path.join(_testConfiguration_1.fixtureDir, "json", "statcrew", "01UA-USC_play_error.json");
/**
 ...
 * @param inputPath Path to JSON file to read in
 */
function readFailedJson(inputPath = exports.defaultFailedFilePath) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield pify(jsonfile.readFile)(inputPath);
    });
}
exports.readFailedJson = readFailedJson;
 ...
 */
function focusToSpecificPlay(inputData, quarter, play) {
...
//# sourceMappingURL=_data.helper.js.map