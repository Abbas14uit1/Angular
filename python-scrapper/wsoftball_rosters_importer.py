...
file_handler = logging.FileHandler('logs/wsb-scrapper-{:%Y-%m-%d_%H-%M-%S}.log'.format(datetime.now()))
...
db_name = 'time_cacher_db_roster_wsb.json'
sleep_duration = 12
...
class CacheStore(object):
    ...
    def __init__(self):
        ...
        self.base_cache_location = "cache_roster_wsb/"
