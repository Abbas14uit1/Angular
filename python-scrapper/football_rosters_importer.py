...
file_handler = logging.FileHandler('logs/scrapper-{:%Y-%m-%d_%H-%M-%S}.log'.format(datetime.now()))
...
db_name = 'time_cacher_db_roster.json'
sleep_duration = 12
...
class CacheStore(object):
    ...
    def __init__(self):
        ...
        self.base_cache_location = "cache_roster/"
...
class RosterScrapper(object):
    ...
    def __init__(self, rosters_url, game_by_game_url, team_code, year, sport_code, team_name, sport_year_id):
    ...
    def _parse(self):
        ...
        for rosters_tr in rosters_trs:
            ...
            player_college_yr = rosters_tds[3].renderContents().strip()
            player_gp = rosters_tds[4].renderContents().strip()
            player_gs = rosters_tds[5].renderContents().strip()
            ...
            roster_detail = RosterDetails(division_const, sport_code, game_type, self.sport_year_id,
                                          ...
                                          player_gp, player_gs, self.year, game_details)
...
class RosterDetails(object) :
    ...
    def __init__(self, division_const, sport_code, game_type, sport_year_id, team_code, team_name,
                 ...
                 roster_GP, roster_GS, roster_played_year, roster_games):
...
for yr in years:
    ...
    for team in teams:
        try:
            ...
            rosters_cache_filename = sport_code + "_" + team.team_code + "_" + yr + "_div-" + division + "_" + "rosters_page.html"
            game_by_game_cache_filename = sport_code + "_" + team.team_code + "_" + yr + "_div-" + division + "_" + "gameByGame_page.html"
            ...
            roster_scrapper = RosterScrapper(roster_url, game_by_game_url, team.team_code, yr, sport_code,
                                               team.team_name, team.sports_year_code)
            ...
            logger.info("Completed data insertion in Mongo DB for index: " + str(i) + ", Total players: " + str(len(rosters)) + \
                  ", For Year: " + yr + ", remaining teams: " + str(len(teams) - i) + "\n")
