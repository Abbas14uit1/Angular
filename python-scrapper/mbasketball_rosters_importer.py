...
file_handler = logging.FileHandler('logs/mbb-scrapper-{:%Y-%m-%d_%H-%M-%S}.log'.format(datetime.now()))
...
db_name = 'time_cacher_db_roster_mbb.json'
sleep_duration = 10
...
class CacheStore(object):
    ...
    def __init__(self):
        ...
        self.base_cache_location = "cache_roster_mbb/"
