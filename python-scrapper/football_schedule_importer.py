        ...
        for schedule_detail in schedule_details:
            ...
            if data_available.count() == 0:
                self.mongo_collection.insert({'gameCode': schedule_detail.game_code,
                                              ...
                                              'division': schedule_detail.division,
                                              'gameType': schedule_detail.game_type
                                              })
...
for yr in years:
    ...
    for team in teams:
        try:
            ...
            cache_filename = sport_code + "_" + team.team_code + "_" + yr + "_div-" + division + "_" + "schedule_page.html"
            ...
            print "Scrapping time:<" + now_str + ">, scraping for team href: " + team.team_href + " & team code: " + team.team_code + ", full URL: " + team_url
    ...
    print "Time took to complete year: " + yr + ", seconds: " + str(end_time - start_time) + "\n"
