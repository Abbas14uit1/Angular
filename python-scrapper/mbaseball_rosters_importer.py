...
file_handler = logging.FileHandler('logs/mba-scrapper-{:%Y-%m-%d_%H-%M-%S}.log'.format(datetime.now()))
...
mongo_db = 'athlyte'
mongo_collection = 'Rosters_Others'

db_name = 'time_cacher_db_roster_mba.json'
sleep_duration = 12
...
class CacheStore(object):
    ...
    def __init__(self):
        ...
        self.base_cache_location = "cache_roster_mba/"
