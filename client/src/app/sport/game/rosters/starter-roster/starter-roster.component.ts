...
import { IGameStarterRosterPlayer } from "../../../../../../../typings/athlyte/football/game/game";
import { GameService } from "../../game.service";

@Component({
  selector: "app-starter-roster",
  templateUrl: "./starter-roster.component.html",
  styleUrls: ["./starter-roster.component.css", "../rosters.component.css"],
  providers: [GameService],
})
export class StarterRosterComponent implements OnInit {

  @Input() public gameId: string;
  @Input() public teamId: string;
  @Input() public sportId: string;
  public dataSource: StarterRosterDataSource;
  ...
  public ngOnInit() {
    this.gameService.getStarterRoster(this.gameId, this.teamId, this.sportId)
      .subscribe(
      (roster) => this.data = roster,
      (err) => console.log(err),
      () => this.dataSource = new StarterRosterDataSource(this.data, this.sort),
    );
...
export class StarterRosterDataSource extends DataSource<any> {
  ...
  public connect(): Observable<IGameStarterRosterPlayer[]> {
