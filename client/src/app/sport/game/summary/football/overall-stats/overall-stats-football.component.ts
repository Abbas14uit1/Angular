...
import { ITeamStatRows, ITeamStats } from "../../../../../../../../typings/athlyte/football/game/game.d";
@Component({
  selector: "app-overall-stats-football",
  templateUrl: "./overall-stats-football.component.html",
  styleUrls: ["./overall-stats-football.component.css", "../summary-football.component.css"],
})
export class OverallStatsFootballComponent implements OnInit {
